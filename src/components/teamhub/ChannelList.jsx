        ...
        return (
            ...
            >
                <div className="relative">
                    {user?.initials ? (
                        <div
                            className="w-5 h-5 rounded rounded-md flex items-center justify-center text-white text-[10px] font-bold"
        ...
        <>
            <div className="w-[260px] flex-shrink-0 bg-[#1a1a1a] flex flex-col h-full border-r border-[#404040]">
                ...
                <div className="p-3 bg-[#171717] border-t border-[#404040] flex items-center gap-3">
                    <div className="relative">
                        <div className="w-9 h-9 rounded bg-orange-500 flex items-center justify-center text-white font-bold">CG</div>
                        <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-emerald-500 border-2 border-[#171717]"></div>
                    </div>
                    <div className="flex-1 min-w-0">
                        <div className="text-sm font-bold text-white truncate">Christopher George</div>
